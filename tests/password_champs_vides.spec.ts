...
test('Mot de passe - Cas non passant (Popup)', async ({ page }) => {
    ...
    // 3. Action: Cliquer sur Enregistrer direct (Formulaire vide)
    // El popup prends du temps pour apparaitre , Playwright l attends
    await page.getByRole('button', { name: 'Enregistrer' }).click();

    // 4. Assertion: verifier le messages d'erreur en rouge
    ...
    // 5. Action: Annuler pour fermer le Popup proprement
